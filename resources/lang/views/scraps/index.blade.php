                                ...
                                <tr>
                                    ...
                                    <td class="center visible-md visible-lg">
                                        <div class="btn-action3">
                                            <a href="{{url("show/$value->loja_id/$value->created_at/$value->device/h1")}}" class="colorbox"><span class="btn-sm {{ $turno1 }}"   data-tt="tooltip" title="Manhã"><i class="fa fa-cloud"></i></span></a>
                                            <a href="{{url("show/$value->loja_id/$value->created_at/$value->device/h2")}}" class="colorbox"><span class="btn-sm {{ $turno2 }}" data-tt="tooltip" title="Tarde"><i class="fa fa-sun-o"></i></span></a>
                                            <a href="{{url("show/$value->loja_id/$value->created_at/$value->device/h3")}}" class="colorbox"><span class="btn-sm {{ $turno3 }}" data-tt="tooltip" title="Noite"><i class="fa fa-moon-o"></i></span></a>
                                        </div>
                                    </td>
                                    <td class="center">
