...
class AdminLTE
{
    ...
    {
        return [
            ADMINLTETEMPLATE_PATH.'/retail/public/img'                 => public_path('img'),
            ADMINLTETEMPLATE_PATH.'/retail/public/css'                 => public_path('css'),
            ADMINLTETEMPLATE_PATH.'retail/public/js'                  => public_path('js'),
            ADMINLTETEMPLATE_PATH.'retail/public/plugins'             => public_path('plugins'),
            ADMINLTETEMPLATE_PATH.'retail/public/fonts'               => public_path('fonts'),
            ADMINLTETEMPLATE_PATH.'retail/public/mix-manifest.json'   => public_path('mix-manifest.json'),
        ];
    }
    ...
    {
        return [
            ADMINLTETEMPLATE_PATH.'retail/resources/views/errors'            =>
                resource_path('views/errors'),
            ADMINLTETEMPLATE_PATH.'retail/resources/views/welcome.blade.php' =>
                resource_path('retail/views/welcome.blade.php'),
            ADMINLTETEMPLATE_PATH.'retail/resources/views/layouts/partials/sidebar.blade.php' =>
                resource_path('retail/views/vendor/adminlte/layouts/partials/sidebar.blade.php'),
        ];
    }
