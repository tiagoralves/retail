...
class CreateActiveWalmartMexico extends Command
{

    protected $signature = 'CreateActiveWalmartMexico:insert';
    ...
    public function handle()
    {
        ...
        $lojadb = DB::table('lojas')->where(['descricao' => 'Walmart', 'pais_id' => 4])->first();
        $loja_id = $lojadb->id;
        ...
        $urlDesktopMexico = [
            'walmart.com.mx',
            'walmart.com.mx/Celulares/Smartphones',
            'walmart.com.mx/TV-y-Video/Pantallas',
            'walmart.com.mx/Linea-Blanca/Refrigeradores-y-Congeladores',
            'walmart.com.mx/Linea-Blanca/Lavadoras-y-Secadoras/Lavadoras',
        ];
        ...
        foreach ( $urlDesktopMexico as $value):
            ...
            if ($image !== false) {
                ...
                $name = "Mexico_".$loja."_Desktop_".$tipo.$data.$turno.".jpg";
        ...
        foreach ( $urlMobileMexico as $value):
            ...
            if ($image !== false) {
                ...
                $image= base64_encode($image);
                $image = base64_decode($image);
                $name = "Mexico_".$loja."_Mobile_".$tipo.$data.$turno.".jpg";
                $im = @imagecreatefromstring($image);
                header('Content-Type: image/jpg');
        ...
        //import.io
        //Mexico_Walmart_Desktop_Homepage_Ads
        $requestAds = $client->request('GET', 'https://data.import.io/extractor/37a59754-0497-47a2-8350-2a3263aaa431/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
        ...
        //Mexico_Walmart_Desktop_Homepage_Organic
        $requestDeskHomOrg = $client->request('GET', 'https://data.import.io/extractor/a4070d81-194b-476e-90e4-9eb6c5e64f83/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Mexico_Walmart_Desktop_Homepage_Carousel
        $requestDeskHomCar = $client->request('GET', 'https://data.import.io/extractor/e628abd4-d131-4cc6-ae90-765a4adca5e9/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        $dadosDeskHomCar = $requestDeskHomCar['result']['extractorData']["data"];
        $position = 1;
        ...
        //Mexico_Walmart_Mobile_Homepage_Ads
        $requestAds = $client->request('GET', 'https://data.import.io/extractor/37a59754-0497-47a2-8350-2a3263aaa431/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
        ...
        //Mexico_Walmart_Mobile_Homepage_Organic
        $requestDeskHomOrg = $client->request('GET', 'https://data.import.io/extractor/a4070d81-194b-476e-90e4-9eb6c5e64f83/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
        ...
        //Mexico_Walmart_Mobile_Homepage_Carousel
        $requestDeskHomCar = $client->request('GET', 'https://data.import.io/extractor/e628abd4-d131-4cc6-ae90-765a4adca5e9/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
