...
class CreateActiveLiverpool extends Command
{

    protected $signature = 'CreateActiveLiverpool:insert';
    ...
    public function handle()
    {
        ...
        $horainicioG1 = strtotime('03:00:00');
        $horafinalG1 = strtotime('10:59:00');
        $horainicialG2 = strtotime('11:00:00');
        $horafinalG2 = strtotime('18:59:00');

        $horainicialG3 = strtotime('19:00:00');
        $horafinalG3 = strtotime('02:59:00');
        $horaAtual = time();


        if($horaAtual >= $horainicioG1 && $horaAtual <= $horafinalG1){
            $turno = "G1";
        } elseif($horaAtual >= $horainicialG2 && $horaAtual <= $horafinalG2){
            $turno = "G2";
        } elseif($horainicialG3 <= $horaAtual && $horaAtual >= $horafinalG3){
            $turno = "G3";
        }

        $lojadb = DB::table('lojas')->where('descricao', 'Liverpool')->first();
        $loja_id = $lojadb->id;
        ...
        $urlDesktopMexico = [
            'liverpool.com.mx/tienda/home.jsp',
            'liverpool.com.mx/tienda/celulares/cat4450173',
            'liverpool.com.mx/tienda/pantallas/cat480023',
            'liverpool.com.mx/tienda/refrigeradores-y-congeladores/cat610026',
            'liverpool.com.mx/tienda/lavadoras/cat861227'
        ];
...
//        $options["proxy"] = 'sonar:sonar@2017@mexico.wonderproxy.com:10000';
        ...
        $urlMobileMexico = [
            //liverpool
            'liverpool.com.mx/tienda/m/',
            'liverpool.com.mx/tienda/m/ver-todos-los-modelos/cat5070000',
            'liverpool.com.mx/tienda/m/pantallas/cat480023',
            'liverpool.com.mx/tienda/m/refrigeradores-y-congeladores/cat610026',
            'liverpool.com.mx/tienda/m/lavadoras/cat861227',
        ];
        ...
        //Mexico_Liverpool_Mobile_Homepage_Ads
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/9d1601b0-f837-4369-b6c4-2b1922c156f0?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=https%3A%2F%2Fwww.liverpool.com.mx%2Ftienda%2Fm%2F',
            [
                'headers' => [
        ...
        //Mexico_Liverpool_Desktop_Homepage_Ads
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/cdf0d8c1-c4cb-4776-aa16-db07f55e1c43?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=https%3A%2F%2Fwww.liverpool.com.mx%2Ftienda%2Fhome.jsp',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Mexico_Liverpool_Mobile_Homepage_Organic
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/82629676-c0bb-40d0-9bc8-778d60180718?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=https%3A%2F%2Fwww.liverpool.com.mx%2Ftienda%2Fhome.jsp',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        foreach ( $dadosRequest as $dado):
            ...
            foreach ($dado["group"]  as $value):
                if (isset($value["Image"][0]["src"])) {
                    ...
                    $im = @imagecreatefromstring($image);
                    header("Content-type: image/jpg");
                    @imagejpeg($im, "/var/www/html/sonar/public/prints_html/mexico/mobile/".$dt[0]."/".$dt[1]."/".$name);
        ...
        //Mexico_Liverpool_Desktop_Homepage_Organic
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/a019f74e-0c0d-406a-ac75-3373dcceec87?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=https%3A%2F%2Fwww.liverpool.com.mx%2Ftienda%2Fhome.jsp',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Mexico_Liverpool_Mobile_Homepage_Carousel
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/f7dbf09b-390e-482c-8bd8-b801bbbcf5ba?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=https%3A%2F%2Fwww.liverpool.com.mx%2Ftienda%2Fhome.jsp',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Mexico_Liverpool_Desktop_Homepage_Carousel
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/33ee5f04-0f1a-4042-a2c9-c4664c251b34?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=https%3A%2F%2Fwww.liverpool.com.mx%2Ftienda%2Fhome.jsp',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
