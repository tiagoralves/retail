...
class CreateActiveFravega extends Command
{

    protected $signature = 'CreateActiveFravega:insert';
    ...
    public function handle()
    {
        ...
        $lojadb = DB::table('lojas')->where('descricao', 'Fravega')->first();
        $loja_id = $lojadb->id;
        ...
        $urlDesktopArgentina = [
            'fravega.com',
            'fravega.com/celulares/celulares-liberados',
            'fravega.com/tv-y-video/tv',
            'fravega.com/heladeras-freezers-y-cavas',
            'fravega.com/lavado'
        ];
        ...
        foreach ( $urlDesktopArgentina as $value):
            ...
            if ($image !== false) {
                ...
                $name = "Argentina_".$loja."_Desktop_".$tipo.$data.$turno.".jpg";
        ...
        foreach ( $urlArgentinaMobile as $value):
            ...
            if ($image !== false) {
                ...
                $image= base64_encode($image);
                $image = base64_decode($image);
                $name = "Argentina_".$loja."_Mobile_".$tipo.$data.$turno.".jpg";
                $im = @imagecreatefromstring($image);
                header('Content-Type: image/jpg');
        ...
        //Argentina_Fravega_Desktop_Category_Organic Celular
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Fcelulares%2Fcelulares-liberados',
            [
                'headers' => [
        ...
        //Argentina_Fravega_Mobile_Category_Organic Celular
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Fcelulares%2Fcelulares-liberados',
            [
                'headers' => [
                    'Accept' => 'application/json',
        ...
        //Argentina_Fravega_Desktop_Category_Organic TV
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Ftv-y-video%2Ftv',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Argentina_Fravega_Mobile_Category_Organic TV
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Ftv-y-video%2Ftv',
            [
                'headers' => [
                    'Accept' => 'application/json',
        ...
        //Argentina_Fravega_Desktop_Category_Organic Geladeira
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Fheladeras-freezers-y-cavas',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Argentina_Fravega_Mobile_Category_Organic Geladeira
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Fheladeras-freezers-y-cavas',
            [
                'headers' => [
                    'Accept' => 'application/json',
        ...
        //Argentina_Fravega_Desktop_Category_Organic Maquiena de Lavar
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/102bd320-7f22-4b70-af8e-c794dec550d5?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.fravega.com%2Flavado',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Argentina_Fravega_Desktop_Homepage_Organic
        $request = $client->request('GET', 'https://data.import.io/extractor/ceee93ac-7342-4399-8a48-535c6255f0e4/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Argentina_Fravega_Desktop_Homepage_Carousel
        $request = $client->request('GET', 'https://data.import.io/extractor/a02aa172-ac64-4275-bb35-3d2c2ac70e5b/json/latest?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        foreach ( $dadosRequest as $dado):
            ...
            foreach ($dado["group"]  as $value):
                if (isset($value["Image"][0]["text"])) {
                    ...
                    $im = @imagecreatefromstring($image);
                    header("Content-type: image/jpg");
                    @imagejpeg($im, "/var/www/html/retail/public/printshtml/mobile/argentina/".$dt[0]."/".$dt[1]."/".$name);
