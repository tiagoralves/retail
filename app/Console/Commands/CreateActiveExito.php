...
class CreateActiveExito extends Command
{

    protected $signature = 'CreateActiveExito:insert';
    ...
    public function handle()
    {
        ...
        $lojadb = DB::table('lojas')->where('descricao', 'Exito')->first();
        $loja_id = $lojadb->id;
      ...
      $urlsDesktopColombia = [
            //exito
            'exito.com',
            'exito.com/Tecnologia-Celulares_y_accesorios-Smartphones/_/N-2b5t',
            'exito.com/browse/Tecnologia-TV_y_Video-Televisores/_/N-2csn',
            'exito.com/Electrohogar-Grandes_Electrodomesticos-Neveras/_/N-2ai7?showMoreIds=109170',
            'exito.com/Electrohogar-Grandes_Electrodomesticos-Lavadoras_y_Secadoras/_/N-2aie',
        ];
        ...
        //Colombia_Exito_Desktop_Category_Organic Celular
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/853f99d8-4e4f-42e4-9ed6-50e8891a526c?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.exito.com%2Fbrowse%3FNtt%3Dcelular%2520libre',
            [
                'headers' => [
...
/*                    $pasta = "/var/www/html/retail/public/printshtml/colombia/desktop/".$dt[0]."/".$dt[1]."/";
                    $upload = move_uploaded_file($arqTemp, $pasta . $arqName);*/

                     $image = @file_get_contents($imagem);
                     $image= base64_encode($image);
                     $image = base64_decode($image);
                     $name = "Colombia_".$lojaNome."_Desktop_Category_Organic_Celular_".$data.$turno.$position.".jpg";
        ...
        //Colombia_Exito_Desktop_Homepage_Ads
  /*      $request = $client->request('GET', 'https://extraction.import.io/query/extractor/107ac60f-9926-4dc3-a731-44d35f858095?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.exito.com%2F',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
        ...
        //Colombia_Exito_Desktop_Homepage_Organic
        $request = $client->request('GET', 'https://extraction.import.io/query/extractor/8addec45-0ca7-4132-809b-cb22ceeb8e41?_apikey=69b08086c8674326a53d8fd4a633d2e1a273e2ba260a9b39370e3019dd5397ec97f44c04dd3689aaca2d341ee9caab71434d3d5bae7c9f3be80fbaf63465aa2a3a1cb897066c9c10296a6181dc2dcf2e&url=http%3A%2F%2Fwww.exito.com%2F',
            [
                'headers' => [
                    'Accept' => 'application/json',
                    'Content-type'=> 'application/json',
